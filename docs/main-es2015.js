...
let AppComponent = class AppComponent {
    constructor(translateService, loadingIndicatorService) {
    ...
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        ...
        providers: [
            _core_service_loading_indicator_service__WEBPACK_IMPORTED_MODULE_13__["LoadingIndicatorService"],
            {
                ...
                useFactory: (service) => new _core_service_interceptor_loading_indicator_interceptor_service__WEBPACK_IMPORTED_MODULE_14__["LoadingIndicatorInterceptorService"](service),
                multi: true,
...
let ContractReferenceManagerComponent = class ContractReferenceManagerComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let ContractReferenceManagerModule = class ContractReferenceManagerModule {
};
...
let FileExportComponent = class FileExportComponent {
    constructor() {
...
let FileUploadComponent = class FileUploadComponent {
    ...
    resetUploadAttachment() {
        ...
        const fileInput = document.querySelector('#upload-cpa-input');
        fileInput.value = '';
    }
    submitUpload() {
...
let MosaicIconsComponent = class MosaicIconsComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let SupplierDropdownComponent = class SupplierDropdownComponent {
    constructor() {
...
let LoadingIndicatorInterceptorService = class LoadingIndicatorInterceptorService {
    constructor(loadingIndicatorService) {
        this.loadingIndicatorService = loadingIndicatorService;
    }
    intercept(req, next) {
        this.loadingIndicatorService.onStarted(req);
        return next.handle(req).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["finalize"])(() => this.loadingIndicatorService.onFinished(req)));
    }
};
LoadingIndicatorInterceptorService.ctorParameters = () => [
...
let UploadTableComponent = class UploadTableComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let CpaManagerComponent = class CpaManagerComponent {
    constructor(store, cpaManagerService) {
        this.store = store;
    ...
    enableUploadBtn(supplierSelected) {
        this.supplierSelected = supplierSelected;
    }
};
CpaManagerComponent.ctorParameters = () => [
...
let CpaManagerModule = class CpaManagerModule {
};
...
let CpaManagerService = class CpaManagerService {
...
CpaManagerService.ctorParameters = () => [
...
const LOAD_DOWNLOADS = '[CpaManager] Load Downloads';
const LOAD_DOWNLOADS_SUCCESS = '[CpaManager] Load Downloads Success';
class LoadDownloads {
    constructor(payload) {
...
LoadDownloads.ctorParameters = () => [
    { type: Array }
];
class LoadDownloadsSuccess {
    constructor(payload) {
        this.payload = payload;
        this.type = LOAD_DOWNLOADS_SUCCESS;
    }
}
LoadDownloadsSuccess.ctorParameters = () => [
    { type: Array }
];
...
const LOAD_REPORTS = '[CpaManager] Load Reports';
const LOAD_REPORTS_SUCCESS = '[CpaManager] Load Reports Success';
class LoadReports {
    constructor(payload) {
        this.payload = payload;
...
LoadReports.ctorParameters = () => [
    { type: Array }
];
class LoadReportsSuccess {
    constructor(payload) {
        this.payload = payload;
        this.type = LOAD_REPORTS_SUCCESS;
    }
}
LoadReportsSuccess.ctorParameters = () => [
    { type: Array }
];
...
const LOAD_SUPPLIERS = '[CpaManager] Load Suppliers';
const LOAD_SUPPLIERS_SUCCESS = '[CpaManager] Load Suppliers Success';
class LoadSuppliers {
    constructor(payload) {
        this.payload = payload;
...
LoadSuppliers.ctorParameters = () => [
    { type: Array }
];
class LoadSuppliersSuccess {
    constructor(payload) {
        this.payload = payload;
        this.type = LOAD_SUPPLIERS_SUCCESS;
    }
}
LoadSuppliersSuccess.ctorParameters = () => [
    { type: Array }
];
...
let DownloadsEffects = class DownloadsEffects {
    constructor(actions$, cpaManagerService) {
        this.actions$ = actions$;
        this.cpaManagerService = cpaManagerService;
        this.loadDownloads$ = this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_actions_downloads_actions__WEBPACK_IMPORTED_MODULE_5__["LOAD_DOWNLOADS"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])((action) => {
            return this.cpaManagerService.fetchDownloads().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(data => console.log('From download.effects: ', data)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])((data) => new _actions_downloads_actions__WEBPACK_IMPORTED_MODULE_5__["LoadDownloadsSuccess"](data)));
        }));
    }
};
DownloadsEffects.ctorParameters = () => [
...
const effects = [_reports_effects__WEBPACK_IMPORTED_MODULE_0__["ReportsEffects"], _suppliers_effects__WEBPACK_IMPORTED_MODULE_1__["SuppliersEffects"], _downloads_effects__WEBPACK_IMPORTED_MODULE_2__["DownloadsEffects"]];
...
let ReportsEffects = class ReportsEffects {
    constructor(actions$, cpaManagerService) {
        this.actions$ = actions$;
        this.cpaManagerService = cpaManagerService;
        this.loadReports$ = this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_actions_reports_actions__WEBPACK_IMPORTED_MODULE_5__["LOAD_REPORTS"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])((action) => {
            return this.cpaManagerService.fetchReports().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(data => console.log(data)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])((data) => new _actions_reports_actions__WEBPACK_IMPORTED_MODULE_5__["LoadReportsSuccess"](data)));
        }));
    }
};
ReportsEffects.ctorParameters = () => [
    { type: _ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["Actions"] },
    { type: _service_cpa_manager_service__WEBPACK_IMPORTED_MODULE_4__["CpaManagerService"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
let SuppliersEffects = class SuppliersEffects {
    constructor(actions$, cpaManagerService) {
        this.actions$ = actions$;
        this.cpaManagerService = cpaManagerService;
        this.loadSuppliers$ = this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_actions_suppliers_actions__WEBPACK_IMPORTED_MODULE_5__["LOAD_SUPPLIERS"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])((action) => {
            return this.cpaManagerService.fetchSuppliers().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(data => console.log(data)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])((data) => new _actions_suppliers_actions__WEBPACK_IMPORTED_MODULE_5__["LoadSuppliersSuccess"](data)));
        }));
    }
};
SuppliersEffects.ctorParameters = () => [
    { type: _ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["Actions"] },
    { type: _service_cpa_manager_service__WEBPACK_IMPORTED_MODULE_4__["CpaManagerService"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
/* harmony import */ var _actions_downloads_actions__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../actions/downloads.actions */ "./src/app/cpa-manager/store/actions/downloads.actions.ts");
...
function reducer(state = initialState, action) {
    switch (action.type) {
        case _actions_downloads_actions__WEBPACK_IMPORTED_MODULE_0__["LOAD_DOWNLOADS_SUCCESS"]: {
            return Object.assign({}, state, { downloads: action.payload });
        }
        default:
            return state;
    }
...
const getCpaMangerState = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createFeatureSelector"])('cpa-manager');
const getReportsState = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createSelector"])(getCpaMangerState, (state) => state.reportsManager.reports);
const getDownloadsState = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createSelector"])(getCpaMangerState, (state) => state.downloadsManager.downloads);
const getSuppliersState = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createSelector"])(getCpaMangerState, (state) => state.suppliersManager.suppliers);
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initialState", function() { return initialState; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "reducer", function() { return reducer; });
/* harmony import */ var _actions_reports_actions__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../actions/reports.actions */ "./src/app/cpa-manager/store/actions/reports.actions.ts");
...
function reducer(state = initialState, action) {
    switch (action.type) {
        case _actions_reports_actions__WEBPACK_IMPORTED_MODULE_0__["LOAD_REPORTS_SUCCESS"]: {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initialState", function() { return initialState; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "reducer", function() { return reducer; });
/* harmony import */ var _actions_suppliers_actions__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../actions/suppliers.actions */ "./src/app/cpa-manager/store/actions/suppliers.actions.ts");
...
function reducer(state = initialState, action) {
    switch (action.type) {
        case _actions_suppliers_actions__WEBPACK_IMPORTED_MODULE_0__["LOAD_SUPPLIERS_SUCCESS"]: {
...
let TagManagerComponent = class TagManagerComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let TagManagerModule = class TagManagerModule {
};
